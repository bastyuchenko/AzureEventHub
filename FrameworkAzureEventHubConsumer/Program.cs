...
bool receive = true;
    ...
    public class MyEventProcessor : IEventProcessor
    {
        ...
        {
            return new Task(() => { Console.WriteLine("Process was closed."); });
        }

        public Task OpenAsync(PartitionContext context)
        {
            return new Task(() => { Console.WriteLine("Process was started."); });
        }
        ...
        public Task ProcessEventsAsync(PartitionContext context, IEnumerable<EventData> messages)
        {
            ...
            {
                Console.WriteLine(Encoding.UTF8.GetString(item.GetBytes()));
            }
